...
**Gradio-Chat-Gateway** 是一个轻量级的高性能网关，旨在将基于 Gradio API 部署的开源 AI 模型转换为标准的 OpenAI 兼容 API。允许用户使用标准的 `OpenAI Chat Completion` 格式与多个 Hugging Face Spaces 模型进行交互，极大简化了模型调用流程。
